...
public class MemberController {
	...
	public String joinPOST(MemberVO memberVO) throws Exception {
		...
		memberVO.setMemberPw(encodePw); // 인코딩된 비밀번호 member객체에 다시저장
	...
	public String mailCheckGET(String email) throws Exception {
		...
		/* 이메일 보내기 */
		String setFrom = "eombongsik@naver.com";
		String toMail = email;
		String title = "회원가입 인증 이메일 입니다.";
		String content = "홈페이지를 방문해주셔서 감하합니다." + "<br><br>" + "인증번호는" + checkNum + "입니다." + "<br>"
